...
export default function ApplicationsPage() {
  const { isInitializing, isAuthenticated, applications, reviewApplication, reviewProposal, applicationSaveState } =
    useAppData();
    ...
    <main className="min-h-screen bg-[#f6f8fb] pb-16 text-slate-950">
      <section className="mx-auto w-[min(760px,calc(100%-32px))] py-10 lg:py-14">
        ...
        <div className="mt-6 grid gap-3">
          ...
          {!isInitializing && isAuthenticated && visible.map((application) => (
          ...
          {!isInitializing && isAuthenticated && visible.length === 0 && (
